...
PREFIX = 'trytonspain'
MODULE2PREFIX = {'sale_opportunity_category': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-sale_opportunity_campaign',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-sale_opportunity_campaign'
    },
    classifiers=[
